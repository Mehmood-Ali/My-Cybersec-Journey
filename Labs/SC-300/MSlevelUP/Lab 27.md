...
5.  In **Resource group**, select **Sentinel-RG**..
    
6.  Name the workspace SentinelLogAnalytics55682936.
    
7.  Select a Region close to you.
    
8.  Select **Review + Create** and then **Create**.
    
9.  After the Log Analytics workspace deployment completes, choose the **Refresh** button. Then select your workspace and select **Add**. This will add the workspace to Microsoft Sentinel and open Microsoft Sentinel.
...
> Please note that steps 6-10 will fail due to restrictions within Cloud Slice labs. Please skip steps 6-10. You may continue on with **Task 3** but you will not receive the output expected.
...
4.  After the install finishes, select the **Data connectors** menu item in the Configuration menu.
