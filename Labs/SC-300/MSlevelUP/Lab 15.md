...
5.  In the Identity protection page, in the left navigation under **Protect**, select **Multifactor authentication registration policy**.
    ...
    ![Screen image displaying the MFA registration policy page with browsing path highlighted](https://raw.githubusercontent.com/MicrosoftLearning/SC-300-Identity-and-Access-Administrator/refs/heads/CloudSlice-and-M36tenant/Instructions/Labs/media/lp2-mod4-browse-to-mfa-registration-policy.png)
...
3.  Under **Assignments**, select **All users** under Users, and select a user to enforce MFA.
    
4.  Change **Policy enforcement** **Enabled**.
...
You have successfully completed this Lab. Click **Next** to advance to the next
