...
4.  On the Terms of use page, on the top menu, select **\+ New terms**
    ...
    ![Screen image displaying the Terms of use page with New terms highlighted](https://raw.githubusercontent.com/MicrosoftLearning/SC-300-Identity-and-Access-Administrator/refs/heads/CloudSlice-and-M36tenant/Instructions/Labs/media/lp4-mod1-new-terms-of-use.png)
...
11.  If you want to expire terms of use consents on a schedule, set **Expire consents** to **On**. When set to On, two additional schedule settings are displayed.
    ...
    ![Expire consents settings to set start date, frequency, and duration](https://raw.githubusercontent.com/MicrosoftLearning/SC-300-Identity-and-Access-Administrator/refs/heads/CloudSlice-and-M36tenant/Instructions/Labs/media/lp4-mod1-new-terms-of-use-create.png)
...
15.  When complete, select **Create**.
    ...
    ![Screen image displaying the New terms of use page with configured options highlighted](https://raw.githubusercontent.com/MicrosoftLearning/SC-300-Identity-and-Access-Administrator/refs/heads/CloudSlice-and-M36tenant/Instructions/Labs/media/lp4-mod1-new-terms-of-use-create.png)
...
2.  Under **Assignments**, select **Users identities**.
    
3.  On the Include tab choose **Select users and groups**, then select **Users and groups** check box.
    
4.  In the Select pane, select **Adele Vance** to use to test the terms of use policy.
...
6.  Select **All cloud apps**.
    
7.  Under **Access controls**, select **Grant**.
    
8.  In the Grant pane, select **Contoso Terms of Use** and then select **Select**.
    
9.  Under **Enable policy**, select **On**.
    
10.  When complete, select **Create**.
    
    ![Screen image displaying the conditional access policy with configuration options highlighted](https://raw.githubusercontent.com/MicrosoftLearning/SC-300-Identity-and-Access-Administrator/refs/heads/CloudSlice-and-M36tenant/Instructions/Labs/media/lp4-mod1-terms-of-use-ca-policy.png)
    
11.  If you chose to use your own account, you can refresh your browser. You will be prompted to sign in again. When you sign in, you will be required to accept the terms of use.
...
2.  For a terms of use, select the numbers under **Accepted** or **Declined** to view the current state for users.
    ...
    ![Screen image displaying the terms of use with the Accepted and Declined columns highlighted](https://raw.githubusercontent.com/MicrosoftLearning/SC-300-Identity-and-Access-Administrator/refs/heads/CloudSlice-and-M36tenant/Instructions/Labs/media/lp4-mod1-terms-of-use-accept-decline.png)
...
3.  In this exercise you may not have any accepted or declined terms of use. In the following example, the **Accepted** value was selected. You can see the reported user information for those that have accepted the terms of use.
    ...
    ![Terms of use consents pane listing the users that have accepted](https://raw.githubusercontent.com/MicrosoftLearning/SC-300-Identity-and-Access-Administrator/refs/heads/CloudSlice-and-M36tenant/Instructions/Labs/media/accepted-tou.png)
...
1.  Once a terms of use is created and enforced, users who are in scope will see the terms of use page.
    ...
    ![Example terms of use that appears when a user signs in](https://raw.githubusercontent.com/MicrosoftLearning/SC-300-Identity-and-Access-Administrator/refs/heads/CloudSlice-and-M36tenant/Instructions/Labs/media/user-tou.png)
    
2.  Users can view the terms of use and, if necessary, use buttons to zoom in and out.
    
    ![View of terms of use with zoom buttons](https://raw.githubusercontent.com/MicrosoftLearning/SC-300-Identity-and-Access-Administrator/refs/heads/CloudSlice-and-M36tenant/Instructions/Labs/media/zoom-buttons.png)
    
3.  On mobile devices, the terms of use will be displayed similar to the following example.
    
    ![Example terms of use that appears when a user signs in on a mobile device](https://raw.githubusercontent.com/MicrosoftLearning/SC-300-Identity-and-Access-Administrator/refs/heads/CloudSlice-and-M36tenant/Instructions/Labs/media/mobile-tou.png)
...
2.  Select the user profile photo and then select **View account**. On the Overview page, select VIEW SETTINGS AND PRIVACY.
    ...
    ![Screen image of a popup which says "View settings and privacy"](https://raw.githubusercontent.com/MicrosoftLearning/SC-300-Identity-and-Access-Administrator/refs/heads/CloudSlice-and-M36tenant/Instructions/Labs/media/lp4-mod1-myaccount-setting-and-privacy.png)
    
3.  On the Settings & Privacy page, select the **Privacy** tab.
    
    ![Screen image displaying the settings and privacy page with organization](https://raw.githubusercontent.com/MicrosoftLearning/SC-300-Identity-and-Access-Administrator/refs/heads/CloudSlice-and-M36tenant/Instructions/Labs/media/lp4-mod1-myaccount-setting-and-privacy-org-notes.png)
...
6.  In the Edit terms of use pane, you can change the following:
    ...
    *   You can add a language to an existing ToU If there are other settings you would like to change, such as require users to consent on every device, expire consents, duration before reacceptance, or Conditional Access policy, you must create a new terms of use.
    ...
    ![Screen image of the Identity Governance terms of use being edited.](https://raw.githubusercontent.com/MicrosoftLearning/SC-300-Identity-and-Access-Administrator/refs/heads/CloudSlice-and-M36tenant/Instructions/Labs/media/lp4-mod1-edit-terms-of-use.png)
...
3.  In the **Language Options** table, identify the terms of use language you want to update and then, in the **Action** column, select **Update**.
    ...
    ![Screen image displaying the terms of use with the update option highlighted](https://raw.githubusercontent.com/MicrosoftLearning/SC-300-Identity-and-Access-Administrator/refs/heads/CloudSlice-and-M36tenant/Instructions/Labs/media/lp4-mod1-edit-terms-of-use-update.png)
