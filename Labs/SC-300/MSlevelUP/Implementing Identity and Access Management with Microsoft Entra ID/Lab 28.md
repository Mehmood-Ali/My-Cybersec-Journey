...
3.  A new tab will open for **Identity Protection | Sign-in risk policy**. **Note** - by default the Get Started button will open in Azure Portal. You can use the portal or return to the Entra admin center. Either wil work.
    
4.  Under Assignments, the **All Users** text.
    
5.  Under Include, select All users.
    
6.  Under Exclude, select Users and groups and choose your **MOD Administrator** account.
    
    *   Microsoft recommends you exclude at least one account to prevent yourself from being locked out.
7.  Under Sign-in risk - select the text that says **Low and above**.
    
8.  Choose **Medium and above** then select **Done**.
    
9.  In the **Controls** section choose the text that says **Block access**.
    
10.  Select **Allow access - Require multifactor authentication**.
    
11.  Select Done.
    
12.  Confirm your settings and set policy enforcement to **Enabled**.
