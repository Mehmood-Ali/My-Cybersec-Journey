...
5.  In the Identity protection page, in the left navigation, select **User risk policy**.
    ...
    ![Screen image displaying the User risk policy page and highlighted browsing path](https://raw.githubusercontent.com/MicrosoftLearning/SC-300-Identity-and-Access-Administrator/refs/heads/CloudSlice-and-M36tenant/Instructions/Labs/media/lp2-mod4-browse-to-identity-protection.png)
