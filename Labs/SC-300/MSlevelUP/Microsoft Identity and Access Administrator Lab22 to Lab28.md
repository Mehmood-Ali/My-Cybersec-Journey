...
4.  On the top menu, select **\+ New Catalog**.
    ...
    ![Screen image displaying the Identity governance catalog page with the New catalog menu highlighted ](https://raw.githubusercontent.com/MicrosoftLearning/SC-300-Identity-and-Access-Administrator/refs/heads/CloudSlice-and-M36tenant/Instructions/Labs/media/lp4-mod1-identity-governance-new-catalog.png)
...
8.  You may choose to enable the catalog for immediate use or disable if you intend to stage it or keep it unavailable until you intend to use it. For this exercise, the catalog does not need to be enabled.
    
    ![Screen image displaying the New catalog pan with the Name, Description, Enabled, and Create options highlighted](https://raw.githubusercontent.com/MicrosoftLearning/SC-300-Identity-and-Access-Administrator/refs/heads/CloudSlice-and-M36tenant/Instructions/Labs/media/lp4-mod1-new-catalog-marketing.png)
...
7.  For this exercise, it is okay to choose any resource you may have available.
    ...
    ![Add resources to a catalog](https://raw.githubusercontent.com/MicrosoftLearning/SC-300-Identity-and-Access-Administrator/refs/heads/CloudSlice-and-M36tenant/Instructions/Labs/media/catalog-add-resources.png)
...
2.  In the Marketing catalog page, in the left navigation menu, select **Roles and administrators**.
    ...
    ![Screen image displaying the Roles and administrators page for the Marketing catalog](https://raw.githubusercontent.com/MicrosoftLearning/SC-300-Identity-and-Access-Administrator/refs/heads/CloudSlice-and-M36tenant/Instructions/Labs/media/lp4-mod1-catalog-roles-and-admins.png)
...
3.  Review the setting and, under **Properties** \> **Enabled**, select **Yes**.
    ...
    ![Screen image displaying the properties being enabled.](https://raw.githubusercontent.com/MicrosoftLearning/SC-300-Identity-and-Access-Administrator/refs/heads/CloudSlice-and-M36tenant/Instructions/Labs/media/lp4-mod1-edit-marketing-catalog.png)
...
2.  Under the Access review menu, you can select **Access reviews** to configure an access review for guest users.  You will select **\+ New access review** to create your guest user access review.  The tile will open to configure the access review for guest users.
    
3.  Select **Teams + Groups** for **Select what to review**.
    
4.  Under **Select review scope**, select **All Microsoft 365 groups with guest users**
    
5.  Under **Select user scope**, select **Guest users only**.
    
6.  Select **Next: Reviews**.
    
7.  The next tile is where you configure who reviews and approves access, how often access will be reviewed, and when access will expire.
    
8.  Under **Select reviewers**, select **Group owners** as these reviewers.
    
    *   **Note**: Guest users should not be allowed to review their own access as a good identity governance practice.
9.  Enter a **Duration (in days)**, default is 3, choose a **Review recurrence** and **Start date** for the review.
    
10.  Select **Next: Settings** and configure the settings for how the review will take place and what happens when the guest user responds or does not respond. A good practice is to select **Auto apply results to resource** and select **Remove access** for **If reviewers don't respond**.
    
11.  Select **Next: Review + create**, and select **Create** to create the new Access review.
